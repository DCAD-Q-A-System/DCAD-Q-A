    ...
    return (
      <>
            ...
            <div className="builder-columns div-13">
                ...
                <div className="div-14">
                    ...
                    <div className="div-24">
                        ...
                        Phasellus id pharetra eros, id luctus orci. et feugiat diam
                        blandit a.
                        </div>
                    </div>
                    </div>
        ...
        <style>
            ...
            padding-bottom: 10px;
            padding-left: 700px;
            background-color: rgba(104, 36, 109, 1);
            }
            .div-3 {
            max-width: 517px;
            ...
            .lorem-ipsum-dolor-sit-amet-co-2 {
            max-width: 168px;
            margin-top: 7px;
            color: rgba(0, 0, 0, 1);
            font-size: 16px;
